    ...
    Table.prototype.data = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!dbKnex)
                    return [2 /*return*/];
                return [2 /*return*/, dbKnex(this.tableName).select("*")];
            });
        });
    };
    return Table;
}());
function getRoot(tablesName) {
    var root = {};
    tablesName.map(function (name) {
        root[name] = function () { return new Table(name); };
    });
    return root;
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    tablesName = (_a.sent()).map(function (single) { return single.name; });
                    app = express();
                    //app.use(jwt({ secret: "lol" }).unless({ path: ["/auth"] }));
                    app.use("/api", graphql({
                        schema: graphql$1.buildSchema("\n            type Table {\n                columns: [String],\n                data: [String]\n            }\n            type Query {\n                " + tablesName.map(function (name) {
                            return name + ": Table";
                        }) + "\n            }\n        "),
                        graphiql: true,
