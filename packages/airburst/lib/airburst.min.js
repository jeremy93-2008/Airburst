...
function getTablesName(db, driver) {
    return __awaiter$1(this, void 0, void 0, function () {
        return __generator$1(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getSQLTable(db, driver)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
}
function getSQLTable(db, driver) {
    return __awaiter$1(this, void 0, void 0, function () {
        var _a;
        return __generator$1(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = driver;
                    switch (_a) {
                        case "mssql": return [3 /*break*/, 1];
                        case "mysql": return [3 /*break*/, 3];
                        case "sqlite3": return [3 /*break*/, 5];
                        case "postgres": return [3 /*break*/, 7];
                        case "oracle": return [3 /*break*/, 9];
                    }
                    return [3 /*break*/, 11];
                case 1: return [4 /*yield*/, db.raw('select table_name from information_schema.tables where table_schema = \'public\' and table_catalog = ?')];
                case 2: return [2 /*return*/, _b.sent()];
                case 3: return [4 /*yield*/, db.raw("select table_name from information_schema.tables where table_schema = ?")];
                case 4: return [2 /*return*/, _b.sent()];
                case 5: return [4 /*yield*/, db.raw("SELECT name FROM sqlite_master WHERE type='table';")];
                case 6: return [2 /*return*/, _b.sent()];
                case 7: return [4 /*yield*/, db.raw("select table_name from information_schema.tables where table_schema = \'public\' and table_catalog = ?")];
                case 8: return [2 /*return*/, _b.sent()];
                case 9: return [4 /*yield*/, db.raw("select table_name from user_tables")];
...
var Table = /** @class */ (function () {
    ...
    Table.prototype.data = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!dbKnex)
                    return [2 /*return*/];
                return [2 /*return*/, dbKnex(this.tableName).select(name ? name : "*")];
            });
        });
    };
    return Table;
}());
function getTableType(currentTable) {
    return __awaiter(this, void 0, void 0, function () {
        var cols, fields;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    console.log({ name: "Table", fields: fields });
                    return [2 /*return*/, new graphql$1.GraphQLObjectType({ name: "Table", fields: fields })];
            }
        });
    });
}
function getQueryType(tablesName) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            tablesName.forEach(function (name) { return __awaiter(_this, void 0, void 0, function () {
                var currentTable, _a, _b, _c, _d, _e;
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, getTableType(currentTable)];
                        case 1:
                            _a[_b] = (_c.type = new (_e.apply(_d, [void 0, _f.sent()]))(),
                                _c.resolve = function () { return currentTable; },
                                _c);
                            return [2 /*return*/];
                    }
                });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 1:
                    _f.sent();
                    return [4 /*yield*/, getTablesName(dbKnex, driver)];
                case 2:
